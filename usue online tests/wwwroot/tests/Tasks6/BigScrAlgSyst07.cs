        ...
        public class Data
        {
            ...
            public string[][] text { get; set; } = {
                new string[] { "\\text{x ∈ P,} \\\\ \\text{y ∈ P}", "x + y ∈ P;",
                               "\\text{(x, y) ∈ P,} \\\\ \\text{(a, b) ∈ P}", "(x + a, y + b) ∈ P;",//2
                               "\\text{(x, y) ∈ P,} \\\\ \\text{(a, b) ∈ P}", "(x + y, a + b) ∈ P.",
                             },
                new string[] { "\\text{(x, y) ∈ Q,} \\\\ \\text{(a, b) ∈ Q}", "(x ⋂ y, a ⋂ b) ∈ Q;",//2
                               "\\text{(x, y) ∈ Q,} \\\\ \\text{(a, b) ∈ Q}", "(x ⋂ a, y ⋂ b) ∈ Q;",
                               "\\text{x ∈ Q,} \\\\ \\text{y ∈ Q}", "x ⋂ y ∈ Q.ф"
                             },
                new string[] { "\\text{x ∈ S,} \\\\ \\text{y ∈ S}", "x * y ∈ S;",
                               "\\text{(x, y) ∈ S,} \\\\ \\text{(a, b) ∈ S}", "(x * y, a * b) ∈ S;",
                               "\\text{(x, y) ∈ S,} \\\\ \\text{(a, b) ∈ S}", "(x * a, y * b) ∈ S.",//3
                             },
                new string[] { "\\text{(x, y) ∈ T,} \\\\ \\text{(a, b) ∈ T}", "(max\\{x, a\\}, max\\{y, b\\}) ∈ T;",//1
